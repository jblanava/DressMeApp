...
public class GestorBD {
    ...
    ********************************************************************************/
     ...
     * @param contexto El contexto a usar.
     * @param nombrePrenda El nombre de la prenda.
     ...
     * @return El ID de la nueva prenda añadida.
     */
    public static int crearPrenda(Context contexto, String nombrePrenda, String color, int tipo, int talla, int visible,int id_perfil) {
        return crearPrenda(contexto, BaseDatos.getNombreBaseDatos(), nombrePrenda, color, tipo, talla, visible, id_perfil);
    }
    public static int crearPrenda(Context contexto, String nombrebd, String nombrePrenda, String color, int tipo , int talla,
                                   int visible, int id_perfil){

        int id= obtenIDMaximoPrenda(contexto, nombrebd);
        String sentenciaSQL;
        sentenciaSQL = String.format("INSERT INTO PRENDA VALUES (%d, '%s', '%s', %d, %d, %d, %d)",
                id, nombrePrenda, color, tipo, talla, visible, id_perfil);
    ...
    public static void borrarPrenda(Context contexto, int id) {
        borrarPrenda(contexto, BaseDatos.getNombreBaseDatos(), id);
    }
    public static void borrarPrenda(Context contexto, String nombrebd, int id) {
        String SentenciaSQL;
    ...
    public static Prenda Obtener_Prenda(Context context, int id) {
        return Obtener_Prenda(context, BaseDatos.getNombreBaseDatos(), id);
    }
    public static Prenda Obtener_Prenda(Context context, String nombrebd, int id){
